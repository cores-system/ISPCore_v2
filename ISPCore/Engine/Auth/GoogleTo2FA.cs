...
namespace ISPCore.Engine.Auth
{
    public class GoogleTo2FA
    {
        ...
        public GoogleTo2FA() : this(true, true) { }

        public GoogleTo2FA(bool useManagedSha1, bool useUnmanagedOnFail)
        {
        ...
        public GoogleAuthCode GenerateSetupCode(string accountTitleNoSpaces, string accountSecretKey, int qrCodeWidth, int qrCodeHeight)
        {
        ...
        /// <param name="qrCodeHeight">QR Code Height</param>
        /// <returns>SetupCode object</returns>
        public GoogleAuthCode GenerateSetupCode(string issuer, string accountTitleNoSpaces, string accountSecretKey, int qrCodeWidth, int qrCodeHeight)
        {
        ...
        /// <returns>SetupCode object</returns>
        public GoogleAuthCode GenerateSetupCode(string issuer, string accountTitleNoSpaces, string accountSecretKey, int qrCodeWidth, int qrCodeHeight, bool useHttps)
        {
            ...
            GoogleAuthCode sC = new GoogleAuthCode();
